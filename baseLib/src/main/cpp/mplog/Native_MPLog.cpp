...
Java_com_master_log_DiskLogManager_init(
	JNIEnv *env,
	jobject thiz,
	jstring _cachePath,
	jstring _logPath,
...
Java_com_master_log_DiskLogManager_write(
	JNIEnv *env,
	jobject thiz,
	jlong handle,
	jstring _text,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_master_log_DiskLogManager_release(JNIEnv *env, jobject thiz, jlong handle) {
	auto *mp_file = (MPLog *)handle;
	mp_file->release();
}
